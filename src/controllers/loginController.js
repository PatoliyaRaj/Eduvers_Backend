...
const CreateLogin = async (req, res) => {
  ...
  try {
    ...
    // Find user by email
    console.log("testing in login controller ");
    const user = await Users.findOne({ where: { email } });
    console.log("🚀 ~ CreateLogin ~ user:", user);
    ...
    // Send response with tokens (also in body for mobile/SPA apps)
...
const RefreshToken = async (req, res) => {
  try {
    ...
    const user = await Users.findOne({
      where: { id: decoded.id, token: refreshToken },
    });
